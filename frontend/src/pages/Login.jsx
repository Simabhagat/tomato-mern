  ...
  return (
    <>
      <div className="text-center bg-red-500 text-white py-4">
        <h1 className="text-2xl font-bold">Sign in to Tomato</h1>
      ...
      <form className="max-w-md mx-auto mt-5 border flex flex-col px-4 py-6" onSubmit={handleSubmit}>
        ...
        <Link className='flex justify-end w-fit self-end' to='/signUp'><p className='pb-2 text-blue-600 text-sm hover:underline'>Don't have an account? Create one</p></Link>
